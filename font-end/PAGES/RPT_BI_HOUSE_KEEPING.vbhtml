<div id="RPT_BI_HOUSE_KEEPING" class="tab-pane">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <span class="card-title">
                    <i class="fa fa-pencil-ruler"></i> Operation
                </span>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-primary card-outline card-outline-tabs">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="pill"
                                               href="#href_tab_id_bi_housekeeping" onclick="fn_tab_change_user_housekeeping('bi_tab')"
                                               role="tab">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="pill"
                                               href="#href_tab_id_db_housekeeping" onclick="fn_tab_change_user_housekeeping('db_tab')"
                                               role="tab">
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="href_tab_id_bi_housekeeping" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                                        ...
                                                                        <a href="javascript:fn_clear_all_by_tab_user_housekeeping('BI')"
                                                                           class="dropdown-item" style="color: black">New</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="bi_date_report_ele_id"
                                                                               onchange="fn_tab_change_user_housekeeping('bi_tab')" class="form-control form-control-sm" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card h-100">
                                                        ...
                                                        <div class="card-body table-responsive">
                                                            <table id="de_posting_tbl_process" class="table table-sm">
                                                                ...
                                                                <tbody>
                                                                    <tr id="">
                                                                        <td nowrap>Update BI User Status</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                        ...
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_update_user_status_bi_user_housekeeping"
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Update BI User Email</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                        ...
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_update_user_email_bi_user_housekeeping"
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Pull Last Login User</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                        ...
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_pull_last_login_user_bi_user_housekeeping"
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Get BI User Housekeeping</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                        ...
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_get_bi_user_housekeeping"
                                                                                   title="Message Generate BI HouseKeeping"
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Get BI User Close</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="td_bi_user_close_bi_housekeeping"> </span>
                                                                        </td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <i id="icon_status_get_bi_user_close_bi_housekeeping"></i>
                                                                            </span>
                                                                        </td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a @*id="icon_ms_get_bi_user_deletion_bi_housekeeping"*@
                                                                                id="icon_ms_get_bi_user_close_bi_housekeeping"
                                                                                   title="Message Get BI User Close"
                                                                                   href="javascript:modals.Open('modual_ms_get_bi_user_close_bi_housekeeping')">
                                                                                    <i class="far fa-envelope fa-lg fa-lg"></i>
                                                                                </a>
                                                                            </span>
                                                                        </td>
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Insert BI User Close</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="td_insert_bi_user_close_bi_housekeeping"> </span>
                                                                        </td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <i id="icon_status_insert_bi_user_close_bi_housekeeping"></i>
                                                                            </span>
                                                                        </td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_insert_bi_user_close_bi_user_housekeeping"
                                                                                   title="Message Insert BI User Close"
                                                                                   href="javascript:modals.Open('modual_ms_insert_bi_user_close_bi_housekeeping')">
                                                                                    <i class="far fa-envelope fa-lg fa-lg"></i>
                                                                                </a>
                                                                            </span>
                                                                        </td>
                                                                    ...
                                                                    <tr id="">
                                                                        <td nowrap>Get BI User Deletion</td>
                                                                        <td nowrap>:</td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="td_get_bi_user_deletion_bi_housekeeping"> </span>
                                                                        </td>
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                        ...
                                                                        <td nowrap colspan="1">
                                                                            <span id="">
                                                                                <a id="icon_ms_get_bi_user_deletion_bi_housekeeping"
                                                                                   title="Message Get BI User Deletion"
                                        ...
                                        <div class="tab-pane fade show" id="href_tab_id_db_housekeeping" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="card h-100">
                                                        <div class="card-header" style="padding-top: 0px">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" id="db_date_report_id" onchange="fn_tab_change_user_housekeeping('db_tab')"
                                ...
                                <div class="card-footer">
                                    <div class="flex-container">
                                        <button id="RptBIHkpGenRptBIHkpBtn" class="btn btn-primary btn-xs"
                                                type="button" onclick="rpt_user_Housekeeping_fn_insert_process_step_all('gen_bi_inactive')">
                                            <i class="fas fa-sync"></i>&nbsp;BI Housekeeping
                                        </button>
                                        <button id="RptBIHkpGenRptBIDlBtn" class="btn btn-primary btn-xs" type="button"
                                                style="display: none"
                                        ...
                                        <button id="rpt_bi_get_user_close" class="btn btn-primary btn-xs" type="button"
                                                style="display: none"
                                                @* onclick="RptBIHkpFnGetReportBIDeletion('getReport')" *@
                                                onclick="rpt_user_Housekeeping_fn_insert_process_step_all('get_bi_close')">
                                            <i class="fas fa-arrow-down"></i>
                                            &nbsp;Get BI User Close
                                        </button>
                                        <button id="RptBIHkpGenDBHkpBtn" class="btn btn-primary btn-xs" type="button"
                                                style="display: none"
                                                @* onclick="RptBIHkpFnGenReportDBHkp()" *@
    ...
    <div class="col-sm-12">
        <div class="card">
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="rang_date_id_user_housekeeping" onchange=""
                                       class="form-control form-control-sm" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-primary card-outline card-outline-tabs">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item active">
                                        <a class="nav-link" data-toggle="pill"
                                           ...
                                           onclick="fn_tab_change_user_housekeeping('bi_listing_tab')" role="tab">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill"
                                           ...
                                           onclick="fn_tab_change_user_housekeeping('bi_deletion_tab')" role="tab">
                                            BI User Deletion Listing
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                           data-toggle="pill" href="#rpt_bi_user_pre_close_listing_tab"
                                           onclick="fn_tab_change_user_housekeeping('pre_close_user_tab')" role="tab">
                                            BI User Remove Listing
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                           data-toggle="pill" href="#rpt_db_user_hkp_listing_tab"
                                           onclick="fn_tab_change_user_housekeeping('db_listing_tab')" role="tab">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="rpt_bi_inactive_listing_tab" role="tabpanel">
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table id="rpt_bi_inactive_listing" cellpadding="0" cellspacing="0"
                                    ...
                                    <div class="tab-pane fade" id="rpt_bi_deletion_listing_tab" role="tabpanel">
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table id="rpt_bi_deletion_listing" cellpadding="0" cellspacing="0"
                                                       class="display nowrap compact table table-bordered table-hover table-sm"
                                                       style="width: 100%">
                                                    <thead>
                                                        <tr>
                                    ...
                                    <div class="tab-pane fade" id="rpt_bi_user_pre_close_listing_tab" role="tabpanel">
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table id="table_listing_user_close" cellpadding="0" cellspacing="0"
                                                       class="display nowrap compact table table-bordered table-hover table-sm"
                                                       style="width: 100%">
                                                    <thead>
                                                        <tr>
                                    ...
                                    <div class="tab-pane fade" id="rpt_db_user_hkp_listing_tab" role="tabpanel">
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table id="tb_listing_db_hkp" cellpadding="0" cellspacing="0"
                                                       class="display nowrap compact table table-bordered table-hover table-sm"
                                                       style="width: 100%">
                                                    <thead>
                                                        <tr>
            ...
            <div class="card-footer">
                <div class="flex-container">
                    <button id="RptBIHkpRefreshBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button" onclick="rpt_user_housekeeping_fn_refresh_listing()">
                        <i id="iconRefreshListing" class="fas fa-sync" style="color: white"></i>&nbsp;Refresh
                    </button>
                    <button id="RptBIHkpOperationBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button" onclick="fnOpenModalOperationBIUserHousekeeping()">
                        <i class="fas fa-pencil-alt" style="color: white"></i>&nbsp;Edit
                    </button>
                    <button id="RptBIHkpReqAuthBTN" style="color: white; font-family: 'Segoe UI'"
                    ...
                    <button id="RptBIHkpSentMailInformBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button"
                    ...
                    <button id="RptDBHkpOperationBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button" onclick="fnOpenModalOperationDBUserHousekeeping()">
                        <i class="fas fa-pencil-alt" style="color: white"></i>&nbsp;Edit
                    </button>
                    <button id="RptDBHkpReqAuthBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button"
                            @* onclick="DBHkpFnInsertaReqAuthStep()" *@
                            onclick="rpt_user_Housekeeping_fn_insert_process_step_all('db_req_auth')">
                        <i class="fa fa-paper-plane fa-flip"></i>&nbsp;Request Authorize
                    </button>
                    <button id="RptDBHkpAuthBTN" style="color: white; font-family: 'Segoe UI'" class="btn btn-primary btn-xs"
                            type="button"
                            @* onclick="DBHkpFnInsertAuthOrRejectStep('AUTH')" *@
                            onclick="rpt_user_Housekeeping_fn_insert_process_step_all('db_auth')">
                        <i class="fa fa-check"></i>&nbsp;Authorize
                    </button>
                    <button id="RptDBHkpRejectBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-danger btn-xs" type="button"
                            @* onclick="DBHkpFnInsertAuthOrRejectStep('REJECT')" *@
                            onclick="rpt_user_Housekeeping_fn_insert_process_step_all('db_reject')">
                        <i class="fa fa-times" style="color: white"></i>&nbsp;Reject
                    </button>
                    <button id="RptDBHkpSentMailInformBTN" style="color: white; font-family: 'Segoe UI'"
                            class="btn btn-primary btn-xs" type="button"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="db_date_report_id">Report Date</label>
                                            <input type="text" id="db_date_report_id" onchange=""
                                                   class="form-control form-control-sm" />
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              <div class="table-responsive">
                                                <table id="rpt_bi_inactive_operation_listing" cellpadding="0" cellspacing="0"
                                                       class="display nowrap compact table table-bordered table-hover table-sm"
                                                       style="width: 100%">
                                                    <thead>
                                                        <tr>
